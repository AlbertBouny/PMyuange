          ...
          children: [
            {
              text: '岗位定义',
              children: [
                '/pm-basics/role-definition/definition/岗位职责.md',
                '/pm-basics/role-definition/definition/工作内容.md'
              ]
            },
            {
              text: '协作关系',
              children: [
                '/pm-basics/role-definition/collaboration/与研发协作.md',
                '/pm-basics/role-definition/collaboration/与设计协作.md',
                '/pm-basics/role-definition/collaboration/与运营协作.md',
                '/pm-basics/role-definition/collaboration/与业务方协作.md'
              ]
            },
            {
              text: '日常工作',
          ...
          children: [
            {
              text: '简历模板',
              children: [
                '/job-hunting/resume/templates/产品经理简历模板.md',
                '/job-hunting/resume/templates/不同方向简历模板.md',
                '/job-hunting/resume/templates/不同工作年限模板.md'
              ]
            },
            {
              text: '撰写指南',
              children: [
                '/job-hunting/resume/writing-skills/README.md',
                '/job-hunting/resume/cases/README.md'
              ]
            }
          ]
        },
          ...
          children: [
            {
              text: '面试流程',
              children: [
                '/job-hunting/interview/process/面试流程.md',
                '/job-hunting/interview/process/评估标准.md'
              ]
            },
            {
              text: '面试技巧',
              children: [
                '/job-hunting/interview/skills/自我介绍.md',
                '/job-hunting/interview/skills/回答技巧.md'
              ]
            },
            {
              text: '面试题库',
              children: [
                '/job-hunting/interview/questions/产品设计.md',
                '/job-hunting/interview/questions/需求分析.md',
                '/job-hunting/interview/questions/数据分析.md'
              ]
            },
            {
              text: '实战演练',
              children: [
                '/job-hunting/interview/practice/模拟面试.md',
                '/job-hunting/interview/practice/案例分析.md'
              ]
            }
          ]
        },
          ...
          children: [
            {
              text: '真实案例',
              children: [
                '/job-hunting/case-study/real-cases/产品改进.md',
                '/job-hunting/case-study/real-cases/新功能设计.md'
              ]
            },
            {
              text: '解决方案',
              children: [
                '/job-hunting/case-study/solutions/问题诊断.md',
                '/job-hunting/case-study/solutions/方案设计.md'
              ]
            },
            {
              text: '产品分析',
              children: [
                '/job-hunting/case-study/product-analysis/竞品分析.md',
                '/job-hunting/case-study/product-analysis/用户研究.md'
              ]
            }
          ]
        },
          ...
          children: [
            {
              text: '职业规划',
              children: [
                '/job-hunting/career/planning/发展路径.md',
                '/job-hunting/career/planning/能力提升.md'
              ]
            },
            {
              text: '职场经验',
              children: [
                '/job-hunting/career/experience/面试心得.md',
                '/job-hunting/career/experience/职场故事.md',
                '/job-hunting/career/experience/求职经验.md'
              ]
            },
            {
              text: '能力提升',
              children: [
                '/job-hunting/career/improvement/核心竞争力.md',
                '/job-hunting/career/improvement/学习资源.md'
              ]
            },
            {
              text: '薪资谈判',
              children: [
                '/job-hunting/career/negotiation/薪资策略.md',
                '/job-hunting/career/negotiation/谈判技巧.md'
              ]
            }
          ]
        },
          ...
          children: [
            {
              text: '内推渠道',
              children: [
                '/job-hunting/channels/internal/内推平台.md',
                '/job-hunting/channels/internal/内推技巧.md'
              ]
            },
            {
              text: '招聘渠道',
              children: [
                '/job-hunting/channels/recruitment/招聘网站.md',
                '/job-hunting/channels/recruitment/求职技巧.md'
              ]
            }
          ]
        }
